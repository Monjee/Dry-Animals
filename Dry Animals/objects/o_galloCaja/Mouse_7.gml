{
    if(o_tienda.visible = true)
    {
        ...
        ini_open("Gatito.sav")
        var test = ini_read_real("Skins", "3", -2); //Es para verificar si el usuario tiene el skin deseado.
        ...
        else // Si esta definido, entonces equipara el skin.
        {
            print("Equipado");
            ini_open("Gatito.sav");
            ini_write_real("Skins", "-1", 3);//Guarda el skin para que cuando entre lo tenga equipado.
            ini_close();
